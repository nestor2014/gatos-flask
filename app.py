...
def get_db_connection():
    # Usamos DATABASE_URL de Render, con fallback a local para pruebas
    conn = psycopg2.connect(os.getenv('DATABASE_URL', 'dbname=animal user=fazadmin password=fazadmin host=localhost port=5432'))
    return conn
